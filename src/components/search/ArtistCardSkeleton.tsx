    ...
    >
      ...
      <View style={{ padding: s(16), paddingBottom: mvs(8) }}>
        ...
        >
          ...
          <View className="flex-1">
            ...
            <Animated.View
              ...
              style={{ width: "60%", height: mvs(16), marginBottom: mvs(4), opacity }}
            />
          </View>
        </View>

        {/* Years of Experience Skeleton */}
        <View
          className="flex-row items-center"
        ...
        >
          ...
          <Animated.View
            className="bg-gray/30 rounded"
            style={{ width: "40%", height: mvs(12), opacity }}
          />
        </View>
        ...
        >
          ...
          <Animated.View
            className="bg-gray/30 rounded"
            style={{ width: "50%", height: mvs(12), opacity }}
          />
        </View>
