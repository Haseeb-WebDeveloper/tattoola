...
export default function AgeStep() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const conversation = await createPrivateRequestConversation(
        user.id,
        String(id),
        {
          size,
      ...
      // Add a small delay to ensure database sync before navigation
      // This prevents the race condition where messages aren't visible on first load
