...
import type { ArtistRegistrationStep2, FormErrors } from '@/types/auth';
...
export default function ArtistRegistrationStep2() {
  const { 
    step2, 
    updateStep, 
    setErrors, 
  ...
  const { pickFiles, takePhoto, uploadToCloudinary, uploading, uploadedFiles } = useFileUpload();
  const [formData, setFormData] = useState<ArtistRegistrationStep2>({
    avatar: undefined,
  });
  ...
  useEffect(() => {
    if (step2 && Object.keys(step2).length > 0) {
      setFormData(step2 as ArtistRegistrationStep2);
    }
  }, [step2]);
    ...
    try {
      ...
      if (files.length > 0) {
        ...
        if (uploadedFiles[0]?.cloudinaryResult) {
          setFormData(prev => ({
            ...prev,
            avatar: uploadedFiles[0].cloudinaryResult?.secureUrl,
          }));
        }
      }
    } catch (error) {
      ...
      >
        ...
        >
          <View style={styles.header}>
            ...
            <StepIndicator currentStep={2} totalSteps={13} />
            
            <Text style={styles.title}>Profile Photo</Text>
            <Text style={styles.subtitle}>
              Add a professional photo to help clients recognize you (optional)
            </Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.privacyNote}>
              ...
              <Text style={styles.privacyText}>
                Your photo will be visible on your artist profile
              </Text>
            </View>
          </View>
