 ...
 */
export async function findOrGetTuttiCollection(ownerId: string): Promise<string | null> {
 ...
 */
export async function isPreferitiCollection(collectionId: string): Promise<boolean> {
